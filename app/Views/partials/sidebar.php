<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            <li class="nav-item cms-mini">
                <button class="nav-link" data-bs-toggle="tab" id="zoomin">
            ...
            <li class="nav-item cms-mini border-bottom ">
                <button class="nav-link" data-bs-toggle="tab" id="zoomout">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24" />
                            <circle fill="#000000" opacity="0.3" cx="12" cy="12" r="10" />
            ...
            <li class="nav-item cms-mini">
                <button class="nav-link" data-bs-toggle="tab" id="back-to-extent">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24" />
            ...
            <li class="nav-item cms-mini border-bottom">
                <button class="nav-link" data-bs-toggle="tab" id="geolocation">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24" />
            ...
            <li class="nav-item cms-mini mt-2">
                <button class="nav-link" data-bs-toggle="tab" id="distance" data-title="Distance Measurement" geomtype="LineString">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24" />
            ...
            <li class="nav-item cms-mini">
                <button class="nav-link" data-bs-toggle="tab" id="area" data-title="Area Measurement" geomtype="Polygon" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24" />
            ...
            <li class="nav-item cms-mini border-bottom">
                <button class="nav-link" data-bs-toggle="tab" id="clear" data-title="Clear Graphics" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24" />
            ...
            <li class="nav-item cms-mini mt-2">
                <button class="nav-link" data-bs-toggle="tab" id="graticule" data-title="Clear Graphics" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24" />
            ...
            <li class="nav-item cms-mini mt-2">
                <button class="nav-link" data-bs-toggle="tab" id="map3d" data-title="Clear Graphics" type="button">
