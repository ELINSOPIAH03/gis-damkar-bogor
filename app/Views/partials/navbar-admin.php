<div class="nav-header">
    <a href="/" class="brand-logo">
        <img class="logo-abbr" src="<?= base_url('assets/images/image-logo.png') ?>" alt="">
        <img class="logo-compact" src="<?= base_url('assets/images/image-logo.png') ?>" alt="">
        <img class="brand-title" src="<?= base_url('assets/images/image-logo.png') ?>" alt="">
    </a>
        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                    <h3>Dashboard GIS Damkar Bogor</h3>
                </div>
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
                            <img src="<?= base_url('assets/images/avatar.png') ?>" width="20" alt="">
